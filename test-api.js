...
//       // Test 3: Add plant (with authentication)
//       console.log('\n3. Testing plant addition...');
//       try {
...
//       // Test 5: Test malformed JSON (should not cause server crash)
...
//           console.log('✅ Malformed JSON properly rejected:', error.response.data);
//         } else {
//           console.log('❌ Unexpected error with malformed JSON:', error.response?.data || error.message);
//         }
//       }
